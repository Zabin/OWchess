...
- **Implemented by:** [IP-4010](../implementation/packages/IP-4010-effect-resolver.md) (mechanism), [IP-4011](../implementation/packages/IP-4011-effect-content.md) (content). Note: `BeliefState.applyDeception` lives in [IP-6010](../implementation/packages/IP-6010-fog-of-war-enforcement.md), assigned there during implementation planning.
