...
- **Implemented by:** [IP-4010](../implementation/packages/IP-4010-effect-resolver.md) (mechanism,
  VERIFIED — VR-4010), [IP-4011](../implementation/packages/IP-4011-effect-content.md) (content,
  VERIFIED — VR-4011, awaiting `09-content-review`). Note: `BeliefState.applyDeception` lives in
  [IP-6010](../implementation/packages/IP-6010-fog-of-war-enforcement.md), assigned there during
